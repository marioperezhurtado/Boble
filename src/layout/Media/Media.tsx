  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute bottom-1 right-1 backdrop-invert backdrop-opacity-20 rounded-md overflow-hidden px-1">
      ...
      {isExpanded &&
        createPortal(
          <>
            ...
            />
            <div className="fixed z-20 w-full -translate-x-1/2 -translate-y-1/2 max-w-screen-md top-1/2 left-1/2 ">
